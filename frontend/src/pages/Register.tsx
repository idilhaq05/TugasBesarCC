        ...
        <div className="flex flex-col px-32 md:px-20 lg:px-0">
          ...
          <form onSubmit={handleSubmit} className="w-80">
            ...
            <div className="mb-4">
              ...
              <input id = "input_username" type="text" placeholder="usernameExample" className="focus:outline-none w-full py-2 border-b border-gray-300 placeholder:text-[#D0D0D0]" value={username} onChange={(e) => setUsername(e.target.value)} required />
            </div>
            <div className="mb-4">
