          ...
          {step === 'email' ? (
            ...
            <form onSubmit={handleSendOTP} className="w-80">
              <div className="mb-6">
                ...
                <input id = "input_email" type="email" placeholder="name@example.com" className="focus:outline-none w-full py-2 border-b border-gray-300 placeholder:text-[#D0D0D0]" value={email} onChange={(e) => setEmail(e.target.value)} required />
              </div>
            ...
            <form onSubmit={handleResetPassword} className="w-80">
              ...
              <div className="mb-4">
                ...
                <input id = "input_new_password" type="password" placeholder="Password baru" className="focus:outline-none w-full py-2 border-b border-gray-300 placeholder:text-[#D0D0D0]" value={password} onChange={(e) => setPassword(e.target.value)} required />
              </div>
              <div className="mb-6">
