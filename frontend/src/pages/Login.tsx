      ...
      <div className="flex flex-col px-20 lg:px-0">
        ...
        <form onSubmit={handleSubmit} className="w-80">
          ...
          <div className="mb-4">
            ...
            <input id = "input_email" type="email" placeholder="name@example.com" className="focus:outline-none w-full mb-4 py-2 border-b-1 placeholder:text-[#D0D0D0]" value={email} onChange={(e) => setEmail(e.target.value)} required />
          </div>
          <div>
            <h3 className="font-medium">Password</h3>
            <div className="relative mb-4">
              <input id = "input_fpassword"
          ...
          <p className="text-sm text-[#454545] mb-4">
            Lupa password?{' '}
            <span className="text-[#008207] hover:underline cursor-pointer" onClick={() => navigate('/reset-password')}>
              {' '}
              Reset password
            </span>
          </p>
